...
!developmentChains.includes(network.name)
    ...
    : describe("Raffle unit tests", function () {
          ...
          describe("enterRaffle", function () {
              ...
              it("doesn't allow entrance when raffle is calcuting", async function () {
                  await raffle.enterRaffle({ value: raffleEntranceFee })
                  await network.provider.send("evm_increaseTime", [
                      interval.toNumber() + 1,
                  ])
                  await network.provider.send("evm_mine", [])
                  // pretending to be chainKeeper
          ...
          describe("checkUpkeep", function () {
              ...
              it("returns false if raffle isnt open", async function () {
                  ...
                  // assert.equal(upkeepNeeded, false) // remove rqual
              })
                  ...
                  await new Promise(async (resolve, reject) => {
                      raffle.once("WinnerPicked", async () => {
                          ...
                          try {
                              ...
                              const numPlayers =
                                  await raffle.getNumberOfPlayer()
